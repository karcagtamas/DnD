...
- Southeast quarter of ancient **Tyar-Besil**
- **The Dark Stream** provided a safe, navigable waterway linking the stronghold with the **Dessarin River** and the surface dominions of the realm
- **Gar Shatterkeel**, the *Prophet of Water* instructed his followers to claim as much of the quarter as they could
...
- Each time when the team is travelling on the **Dark Stream** to or from the temple
...
> *darkmantles* and *pierceers* drop from the tunnel ceiling into the boat. *troglodytes* hurl javelins from the shore where the **Dark Stream** passes through an open cavern. *water weirds* and *chuuls* lurk in the stream and attack from the water
...
| -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Ceilings | 15ft high                                                                                                                                                                                                                                                                                |
| Doors    | Doors consist of stone slabs balanced on central pivots (opening creates two gaps (~3ft)). No locks remain operable, but the cultists secure some doors with a hasp-and-ping closure. DC 15 Stength check to force the open. Double doors have iron hinges and swings like normal doors. |
| Canals   | Water level ~5ft below the floor level and ~15ft deep. The current flows southward from the waterfalls (*C25*). The sides are slippery. Hard to cling to the wall or climb out.                                                                                                          |
| Light    | *Continual flame* spells cast on torches in bronze wall. The rest of the level is dark.                                                                                                                                                                                                  |
| Quays    | Steps leading from the floor level down to just 1ft above water level.                                                                                                                                                                                                                   |
| Treasure | Creatures have 4d10gp of mixed coins.                                                                                                                                                                                                                                                    |

## C1 - Lake Landing

- If the characters arrive by boat from the stream:

> Tűzfény árad egy hatalmas barlangból előttünk. A patak egy hatalmas földalatti tóba torkollik. Jobbra egy omladozó kőrakpart vezet egy északkelet felé vezető alagúthoz. Tíz láb hosszú csónak van a rakparthoz kikötve, és egy fáklya ég egy bronz gyertyatartóban az alagút szájánál. A rakpart mellett egy húsz láb széles csatorna vezet északra a nagy tótól. A tó nyugat felé nyúlik a sötétségbe.

- If the characters come from the otherside of the dungeon:

> A járat egy nagy, sötét barlangba nyílik, amelyet egy földalatti tó tölt meg. A tó keleti végén egy fáklya világít meg egy kőrakpartot, amely mellett egy három méteres csónak van kikötve. A tó nyugati vége eltűnik a sötétségben.

- The quay leading to *C4*
- The landign at the east end of the cavers in guarded by 4 *Crushing Wave reavers* and 1 *fathomer* commanded by 1 *Dark Tide knight* (named **Eyon**)
...
- **Eyon** has a waterproofed leater pouch on her belt
  - 15gp, 6pp, 5 carved coral gemstone (80fp each), *potion of healing*

### C1 - Development

- If the characters defeat the cultists and leave the dungeon, the guards are replace by the cultists in *C7* within an hour

## C2 - Canals

> Két méter széles csatorna vezet az ősi falak között a sötétségbe. A víz lassan mozog, gyenge áramlatra utal. A távolban fáklyafény pislákol.

- Torches positioned near the bridges at *C6*, *C15*, *C24*
- The dwarves of **Besilmer** built the canal to channel the spring in area **C26** away from their delvings and link their city to the world above
- A character can pole a boat through a canal at a speed of 10ft
- Creature wander the canals. Encounter once every hour

| d20  | Encounter                  |
| ---- | -------------------------- |
| 1    | 1d4+1 *ghouls* (*C4*)      |
| 2-3  | 1d4+4 *lizardfolk* (*C13*) |
| 4    | 1d2 *trolls* (*C12*)       |
| 5    | 1 *giant octopus* (*C3*)   |
| 6    | 1 *dragon turtle* (*C21*)  |
| 7-20 | None                       |

## C3 - Whisper Lake

> Ez a földalatti tó sötét, mozdulatlan és hideg. Nyugaton a tó egy kavicsos parton végződik, és egy halvány fáklyafény egy északon lévő csatornára vagy csatornára utal. Délen egy omladozó kőrakpart vezet egy sötét átjáróhoz. A tó keleti végén egy másik fáklya ég egy nagyobb rakpart felett, egy másik átjáró pedig kelet felé. Egy második csatorna vezet északra a tó keleti részéből, és a fénycsóva is onnan érkezik.

- The ceiling is a dome, highest point almost 50ft above the water
- The lake is 20ft deep neart the cavern walls, dropping to 60ft in the middle
- Name from a trick of acoustics
  - A mere whisper spoken in *C1* can easily be heard in *C19* and vice versa
- The lake is home to small blind cave fish
  - A *giant octopus* lurks in a grotto to the south
  - Attackes swimmers or boaters who aproach withinh 30ft

## C4 - Drowning Chambers

> Dohányos, rothadó szag terjeng ebben a kamrában. A padlót nyolc kis medence lyukazza át, mindegyik körülbelül egy méter széles, és színültig fekete, büdös vízzel vannak tele. A medencék közelében több nagy kő hever a padlón, mindegyiket régi kötéldarabok többszörösen körbetekerve. A déli falon egy A szimbólum látható – egy X alakú alak, amelynek alsó ágait vízszintes vonal köti össze.

- Long agoe this chamber serves as the harbormaster's post. Now the cult ceremonially drown captives
- Each pool 10ft deep, stones avg. 50pounds and the ropes are used to bind the victims feet together
- 9 aquatic *ghouls* (30ft swimming speed) lurk in this chamber (previous victims of the cult's obscene rite)
  - 8 more submerged in the pools, and 4 more skulk in the shadows of the ruined enclosure at the west end of the room
- If the ghouls succeed in paralyzing a character
  - The nearest one uses an actio nto tie one of the jeavy stone to paralyzed character's feet
  - On the following turn, the ghoul shoves the paralyzed character int one of the drowning pools
  - DC 20 Strengh (Athletics) to swim up
  - DC 15 Dexterity (Acrobatics) to wriggling free of a safe place

## C5 - Gaol

- An iron hasp-and-pin arrangement secures the door

> Ez a szoba nyilvánvalóan börtönként szolgál. Fél tucat szalmából készült, elnyűtt takaróval letakart raklap hever a padlón, az egyik falnak pedig egy vizeshordó támaszkodik. Egy sötét, résszerű ablak néz nyugatra.

- The cultists currently hold no prisoner in this makeshift jail
- If the characters are defeated in the temple, they are stripped of their gear and confined here while **Gar Shatterkeel** decides how best to dispose of them
...
> Ez a régi kamra hat egyszerű, fából készült priccsel és élelemmel teli zsákokkal van berendezve. Kőajtók nyílnak délre és nyugatra.

- The cultists who guard the lake bunk here
- 6 double bunks: 9 reavers, a priest, a fathomer and a Dark Tide knight named **Eyon**
  - At any given time, 5 *Crushing Wave reaver* and 1 *Crushing Wave priest* are here

## C8 - Ancient Silos

- 2 rooms are identical

> Ezt a nagy szobát omladozó falazat borítja. A padló közepén egy száraz gödör fekszik, amelyet egy másfél méter széles járda vesz körül.

- The rooms were once granaries for the citadel (all the food remained are rooted long time ago)
- The silo spaces are each 30ft deep

## C9 - North Guard Post

- The doors are secured by hasps and pins from inside
- When the characters approach a door:

> Ennek a kőajtónak a közepén egy körülbelül egy négyzetlábnyi vaslemez van elhelyezve.

- Each door has a small square hole covered with a sliding iron plate
  - The cultists use this holes to make crossbows attacked at the intruders
  - Only 1 cultist can shoot out at the hole at a time
- When the characters enter:

> Ez a szoba egyben emeletes szoba és őrhely is. Masszív bronzpántok vannak a két kőajtón, és mindegyik ajtón egy lőrés található, amelyet egy kis vaslemez fed mellmagasságban egy emberen. A szoba közepén egy asztal és négy rozoga faszék áll. Tíz emeletes ágy van itt, bár úgy tűnik, a felük nincs használatban.

- This guard post is manned by a *one-eyed shiver* named **Khalt**, a *Dark Tide knight* named **Gordol** and 3 *Crushing Wave reavers*
  - **Khalt** is in charge and he runs a tight ship
  - These reavers are armed with light crossbows instead of javelins (+4 to hit, 1d8+2 piercing dmg)
  - **Gordol** has a light crossbow (+7 to hit, 1d8+3 piercing dmg)

## C10 - Gargoyle Fountain

> Ez a kamra súlyosan megrongálódott. Számos összeomlott oszlop és meghajló fal árulkodik a hosszú évek múlásáról, de egy jellegzetesség érdekes módon épségben maradt: egy kőszökőkút a nyugati fal közepén. Egy három méter széles, félkör alakú kőből készült vízmedencéből áll, amelynek talapzatán egy vigyorgó vízköpő áll ki a falból. Északra és délre kőajtók nyílnak.

- 2 *nothics* occupy the room, hiding behind the broken colums and rubble chocking the easter parth of the room
- They hope that unwary cult members might be easy prey for ambush
- The let large and well-armed parties to pass through
- Fountain
  - Fed thourgh well-engineered system (taps in *C26*)
  - Modest healing powers
    - Anyone who drinks, gains the benefits of having a finished a short rest
    - But who gains the benefits, can't do again until 24h
    - The water loses its healing power if removed from the fountain
- North tunnel
  - Leads to *B11* of the *Temple of Black Earth*

## C11 - Court of the Merfolk

> Egy ősi szökőkút áll az udvar közepén, amely három táncoló sellőt formáz. A szökőkút kiszáradt, a szobor pedig súlyosan megrongálódott – két sellőnek hiányzik a karja, a harmadiknak pedig a feje. Folyosók vezetnek északra, délre és keletre ebből a teremből. Északról egy fáklyafény dereng fel, keletről pedig egy másik.
> Az északnyugati ajtót festett szimbólumok és vízi motívumokkal díszített képek borítják, amelyeket hosszú karcolások csúfítanak el, elhomályosítva jelentésüket.

- Ceiling is 30ft high
- Vandalism to t he decorations on the northwestern door is the handiwork of **Thuluna Maah** (sea hag in *C14*)

## C12 - Troll Hole

> Ez a szoba koszos. A falak omladoznak és görbék, a padlón szétszórt, sértetlen irhák és bőrök halmai nyers, bűzös szőnyeget alkotnak. Lerágott csontok és törött edények hevernek szanaszét, néhány furcsa páncéldarabbal együtt, amelyek legtöbbje meggörbült, elcsavarodott vagy karmolásnyomoktól csúnyán megkarcolódott. Ajtók északra és keletre vezetnek.

- Lair of 3 aquatic *trolls* (swimming speed: 40ft, ability to breath under water)
  - 2 is here, the other one guards at *C15*
  - **Gorgebelly**, **Marrowsucker**, **Ninetooth**
  - Ignore goings-pn in the dungeon around the, they answers for help
  - Characters disguised as water cultists or insist to do cult business, can convience them easily to stay here
  - Or bribe them to cause trouble somewhere else

## C13 - Blackmaw Den

- The doors are marked with pics of monstrous eyes and fanged maws

> A szobát bűzös hüllőszag tölti meg, és tele van rongyos állatbőrökkel és nyirkos szalmával. A szoba közepén egy forró parázstól teli, megviselt vasüst izzik. A parázs mellett heverő, félig megrágott tetemek közömbös erőfeszítésről tanúskodnak, hogy a parázson megsüssék őket. Két ajtó van: egy északi és egy déli.

- Den of a band of lizardfold
- They call themselves the *Blackmaws*
- They degenerated into savagery
- Remains of the fire cultists can be spotted
- 8 *lizardfolk* are here now including their leader
  - Warrior with 36 HP, named **Tornscale**
  - They armed with javelins, maces and shields
