...
- **Watson** is receptive to his father's and grandfather's new religion, but he remains unaware of its true nature
- **Wiggan** and **Bertram** don't know the cult's ultimate aims, only that i reveres a mighty earth power
- After adventures in the **Sacred Stone Monastery**
  - The cult gives **Wiggan** a mission
  - Lure the characters to the ranch and kill them
  - **Wiggan** wants the characters to pay for any harm they caused to his mentor, **Hellenrae** (the Abbess of Stone)

## Setup

- **Wiggan** and **Betram** have constructed an elaborate ruse
...
- As the characters adventure in the **Sumber Hills**, rumor reaches them of a fire witch dwelling in an **Uthgardt** barrow and terrorizing the **Nettlebees**
  ...
  - The gossop includes much pity for the **Nettlebees** who are known for prize livestock

## Nettlebee Ranch

> A Nettlebee Ranch alacsony, lankás dombok során terül el, ahol az erdőt kiirtották a zab és árpa termése miatt. A Nettlebee család becses állatállománya – juhok, pónik és szarvasmarhák – tömegesen legelész a domboldali legelőkön. A ranch egy nagy, kétszintes házból, valamint számos alacsony istállóból és magtárból áll. A távolban egy természetellenes földkupac magasodik a ranch fölé, kopaszodó koronáját ritkás tarló borítja a fák elszenesedett maradványa.

- Characters might investigate the ranch, the pasture or the fields
- They can go to the barrow mound
- Ranch
  - A barn, granaries and a half-story house that rambles up and down a small hill
- Pasture
  - 100 sheep, 12 cows, 12 oxen, 15 ponies
  - A quarter of the them have been branded upon the rum with the fire symbol
- Fields
  - Oats and barley spraw over two field in the hilly country neart the ranch
  - **Bertram** has hidden the cult bran, made at the ranch's forge, under a scracrow in the fields
...
- **Bertram**'s youngest child: **Ignatius**
  - 12 years old
  - Little boy, everyone favors him
  - He is a happy kid, but the fire witch scare him (nightmares)

### Interviewing the Nettlebees

- **Bertram** and **Wiggan** avoid the characters
  - **Wiggan** plays the role of old halfling who is locked in his study and deals with matters of trade
    - If the characters speak with him: He deals about the how much this situation cost him
      - He pushes the characters to do something
  - **Brigram** inspects his crops, staying out of the way (unless the characters call him to speak)
...
- Informations:
  ...
  - Few days later: **Watson** noticed the brand on the cattle
  - Nettlebees tooke turns tguarding the livestock by night
    - Slowly but surely, the brands continued to appear
  - **Watson** investigates the barrow and found it open
    - The massive fieldstone that once stood in the archway had been sundered and the halls were limned in flame
    - **Watson** heard terrigying whispers from the darkness
    - **Wiggon** spoke of legends of fire witched that once were said to roam these hills, they fear a fire witch has returned
  - They feel powerless against the fire witch and fear she might soon burn down their ranch
    - **Watson** and **Jayne** are desperate about avoiding that outcome

## Barrow Mound

- **Uthgardt** barbarians built the barrow mound to hold the body of a chieftain, now forgotten
- When **Wiggan** joined the **Cult of the Black Earth**, he looted the barrow mound's altars, upsetting the spirit of the chieftain
- Few days before the characters arrived, **Wiggan** and **Bertram** set the barrow ablaze to lend credence to their fire witch ruse
- When the characters go to the barrow mound, **Wiggan** and **Betrtam** follow them (they keep their distance, unless the characters invite them to come along)
- When the characters arrive:

> A halom egy magas dombot zár be, ahonnan kilátás nyílik a környező vidékre. A halom körüli terület mozdulatlan és elszenesedett. Az égett fák sötét ujjcsontokként nyúlnak ki a kopár földhalmokból. Észrevehetően hűvös van itt.

If they accompany the characters openly, **Wiggan** and **Bertram** cower at the edge of the hill, the refuses to set foot upon the "cursed" ground

### Barrow Mound Entrance

- When the characters move to the barrow entrance:

> Magas monolitok szegélyezik a földfolyosót, amely a sírdomb bejáratát a mélyben található sírkamrával köti össze. Lángfoszlányok világítják meg a folyosót és a mögötte lévő kamrát. A levegő hideg és nehéz a hamu szagától.
...
- From the entrance the burial chamber can be see a little at the ened of the hall
  - Except the vague details and the Elk beast altar at the bier's head

### Burial Chamber

- When the characters see the chamber:

> Egy nyers, földkőből készült boltív alkotja a sírkamra bejáratát. Három elágazó fülkében három megégett oltár található – az egyik egy tigrisét, a másik egy jávorszarvasét, a harmadik pedig egy medvéét ábrázolja. A kamra közepén egy kőravatal áll, amelyen egy összetört és megfeketedett csontváz nyugszik, koponyája és végtagjai szétszórva a kamrában. A sírbolt levegője halálosan hideg és hamuillatú.

- 3 alcoves contain altars to best spirits with early depictions of the Red Triger totem (west alcove), the Elk totem (north alcove) and the Blue Bear totem (east alcove)
...
- Cold
  - The bural hall is cold due the presence of the chieftains's restless spirit - The cold is extreme

### The Chieftain's Return

- After the characters have a minute to look around:
...
- **Wiggan** and **Bertram** run for the ranch
- **Javor** sesnse his quarry on the move and rushed the barrow's exit
- The elemental emerges from the earth in the main chamber
  - Attack those who it see (ignore **Javor**)
- While the players fight, **Javor** clears the entry (2 minutes) and leaps into the sunlight
